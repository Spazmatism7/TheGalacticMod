...
{
    public class HellTorch : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<HellTorchPlaced>();
            Item.width = 10;
            Item.height = 12;
            Item.value = 50;
        }
    ...
    public class HellTorchPlaced : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            ItemDrop = ModContent.ItemType<HellTorch>();
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("GalacticMod/Biomes/CharredKingdom/HellTorchPlaced_Flame");
            }
        }
        ...
        /*public override float GetTorchLuck(Player player)
        {
            ...
            bool inExampleUndergroundBiome = player.InModBiome<CharredKingdom>();
