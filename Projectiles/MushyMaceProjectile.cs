...
{
	public class MushyMaceProjectile : ModProjectile
	{
		private const string ChainTexturePath = "GalacticMod/Projectiles/MushyMaceProjectileChain";
		...
		{
			DisplayName.SetDefault("Mushy Mace");
        ...
        public override void AI()
		{
			...
			*/
            ...
            if (Main.rand.NextBool(dustRate))
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.DungeonWater, 0f, 0f, 150, default(Color), 1.3f);
        }
