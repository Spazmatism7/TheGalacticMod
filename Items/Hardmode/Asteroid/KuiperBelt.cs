...
{
    public class KuiperBelt : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToWhip(ModContent.ProjectileType<KuiperBeltP>(), 60, 2, 4);
    ...
    public class KuiperBeltP : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Kuiper Belt");
        ...
        {
            target.AddBuff(ModContent.BuffType<AsteroidBlaze>(), 120);
