...
{
    public class TitaniumDefensePotion : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = BuffType<Buffs.TitaniumDefense>(); //Specify an existing buff to be applied when used.
        ...
        {
            Recipe recipe = Recipe.Create(ItemType<TitaniumDefensePotion>());
