...
{
    public class PalladiumDefensePotion : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = BuffType<Buffs.PalladiumDefense>(); //Specify an existing buff to be applied when used.
        ...
        {
            Recipe recipe = Recipe.Create(ItemType<PalladiumDefensePotion>());
