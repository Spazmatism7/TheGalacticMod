...
namespace GalacticMod.Items.ThrowingClass.Weapons.Knives
{
	public class CobaltKnife : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ProjectileType<CobaltKnifeP>();
			Item.shootSpeed = 8f;
		...
		{
			Recipe recipe = Recipe.Create(ModContent.ItemType<CobaltKnife>(), 25);
	...
	public class CobaltKnifeP : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cobalt Knife");
		}
