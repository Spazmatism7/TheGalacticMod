...
namespace GalacticMod.Items.ThrowingClass.Weapons.Knives
{
	public class AdamantiteKnife : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ProjectileType<AdamantiteKnifeP>();
			Item.shootSpeed = 8f;
		...
		{
			Recipe recipe = Recipe.Create(ModContent.ItemType<AdamantiteKnife>(), 25);
	...
	public class AdamantiteKnifeP : ModProjectile
	{
		public override void SetStaticDefaults()
		{
