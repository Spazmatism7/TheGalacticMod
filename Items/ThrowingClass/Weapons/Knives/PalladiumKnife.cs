...
namespace GalacticMod.Items.ThrowingClass.Weapons.Knives
{
	public class PalladiumKnife : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ProjectileType<PalladiumKnifeP>();
			Item.shootSpeed = 8f;
		...
		{
			Recipe recipe = Recipe.Create(ModContent.ItemType<PalladiumKnife>(), 25);
	...
	public class PalladiumKnifeP : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Palladium Knife");
		}
