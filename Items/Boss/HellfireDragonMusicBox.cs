...
{
    public class HellfireDragonMusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Music Box (Raging Fire)");
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Sounds/Music/RagingFire"), ModContent.ItemType<HellfireDragonMusicBox>(), ModContent.TileType<HellfireDragonMusicBoxTile>());
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<HellfireDragonMusicBoxTile>();
            Item.width = 24;
            Item.height = 24;
    ...
    public class HellfireDragonMusicBoxTile : ModTile
    {
        public override void SetStaticDefaults()
        {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<HellfireDragonMusicBox>());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<HellfireDragonMusicBox>();
        }
    }
}