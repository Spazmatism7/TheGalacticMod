...
{
    #region Unadded
    /*public class DesertSpiritRelic : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Desert Spirit Relic");
        ...
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<Relic_1>(), 0);
    ...
    public class SkyGodRelic : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Sky God Relic");
        ...
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<Relic_2>(), 0);
    ...
    public class JormungandrRelic : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Jörmungandr Relic");
        ...
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<Relic_3>(), 0);
    ...
    public class AsteroidBehemothRelic : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Asteroid Behemoth Relic");
        ...
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<Relic_4>(), 0);
    ...
    public class HellfireDragonRelic : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Hellfire Dragon Relic");
        ...
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<Relic_5>(), 0);
    ...
    public class GalacticPerilRelic : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Galactic Peril Relic");
        ...
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<Relic_6>(), 0);
    ...
    /*public class Relic_1 : ModTile
    {
        ...
        public virtual string RelicTextureName => "GalacticMod/Items/Boss/Master/Relic_1";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "GalacticMod/Items/Boss/Master/RelicPedestal";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<DesertSpiritRelic>();
                    break;
    ...
    public class Relic_2 : ModTile
    {
        ...
        // Every relic has its own extra floating part, should be 50x50. Optional: Expand this sheet if you want to add more, stacked vertically
        // If you do not go the optional way, and you extend from this class, you can override this to point to a different texture
        public virtual string RelicTextureName => "GalacticMod/Items/Boss/Master/Relic_2";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<SkyGodRelic>();
                    break;
                    // Optional: Add more cases here
            }
    ...
    public class Relic_3 : ModTile
    {
        ...
        // Every relic has its own extra floating part, should be 50x50. Optional: Expand this sheet if you want to add more, stacked vertically
        // If you do not go the optional way, and you extend from this class, you can override this to point to a different texture
        public virtual string RelicTextureName => "GalacticMod/Items/Boss/Master/Relic_3";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<JormungandrRelic>();
                    break;
                    // Optional: Add more cases here
            }
    ...
    public class Relic_4 : ModTile
    {
        ...
        // Every relic has its own extra floating part, should be 50x50. Optional: Expand this sheet if you want to add more, stacked vertically
        // If you do not go the optional way, and you extend from this class, you can override this to point to a different texture
        public virtual string RelicTextureName => "GalacticMod/Items/Boss/Master/Relic_4";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<AsteroidBehemothRelic>();
                    break;
                    // Optional: Add more cases here
            }
    ...
    public class Relic_5 : ModTile
    {
        ...
        // Every relic has its own extra floating part, should be 50x50. Optional: Expand this sheet if you want to add more, stacked vertically
        // If you do not go the optional way, and you extend from this class, you can override this to point to a different texture
        public virtual string RelicTextureName => "GalacticMod/Items/Boss/Master/Relic_5";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<HellfireDragonRelic>();
                    break;
                    // Optional: Add more cases here
            }
    ...
    public class Relic_6 : ModTile
    {
        ...
        // Every relic has its own extra floating part, should be 50x50. Optional: Expand this sheet if you want to add more, stacked vertically
        // If you do not go the optional way, and you extend from this class, you can override this to point to a different texture
        public virtual string RelicTextureName => "GalacticMod/Items/Boss/Master/Relic_6";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<GalacticPerilRelic>();
                    break;
                    // Optional: Add more cases here
            }
