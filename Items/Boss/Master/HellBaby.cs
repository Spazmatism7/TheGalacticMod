...
{
    public class HellEgg  : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Hellfire Egg");
            Tooltip.SetDefault("Fire sacrifices required!");
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ProjectileType<HellBaby>(); // "Shoot" your pet projectile.
            Item.buffType = BuffType<HellBabyBuff>(); // Apply buff upon usage of the Item.
        }
    ...
    public class HellBabyBuff : ModBuff
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Hellfire Baby");
        ...
        public override void Update(Player player, ref int buffIndex) //This method gets called every frame your buff is active on your player.
        {
            ...
            int projType = ProjectileType<HellBaby>();
    ...
    public class HellBaby : ModProjectile
    {
        public override void SetStaticDefaults()
        {
