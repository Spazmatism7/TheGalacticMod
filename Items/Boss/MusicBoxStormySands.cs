...
{
    public class MusicBoxStormySands : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Music Box (The Stormy Sands)");
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Sounds/Music/TheStormySands"), ModContent.ItemType<MusicBoxStormySands>(), ModContent.TileType<MusicBoxStormySandsTile>());
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<MusicBoxStormySandsTile>();
            Item.width = 24;
            Item.height = 24;
    ...
    public class MusicBoxStormySandsTile : ModTile
    {
        public override void SetStaticDefaults()
        {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<MusicBoxStormySands>());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<MusicBoxStormySands>();
        }
    }
}