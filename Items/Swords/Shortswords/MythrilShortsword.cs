...
namespace GalacticMod.Items.Swords.Shortswords
{
	public class MythrilShortsword : ModItem
	{
		...
		{
			Tooltip.SetDefault("Little green stabby sword!" +
                "\nAttacks explode into Mythril Shards");
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<MythrilShortswordP>(); // The projectile is what makes a shortsword work
			Item.shootSpeed = 2.1f; // This value bleeds into the behavior of the projectile as velocity, keep that in mind when tweaking values
		}

		public override void AddRecipes()
		{
			Recipe recipe = Recipe.Create(ModContent.ItemType<MythrilShortsword>());
	...
	public class MythrilShortswordP : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
            ...
            for (int i = 0; i < numberProjectiles; i++)
            {
                ...
                Projectile.NewProjectile(null, new Vector2(Projectile.Center.X, Projectile.Center.Y), new Vector2(perturbedSpeed.X, perturbedSpeed.Y), ModContent.ProjectileType<MythrilShards>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
    ...
    public class MythrilShards : ModProjectile
    {
        public override void SetDefaults()
        {
            Projectile.width = 12;
