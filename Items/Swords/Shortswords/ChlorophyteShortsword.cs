...
{
	public class ChlorophyteShortsword : ModItem
	{
		public override void SetStaticDefaults() 
		{
			Tooltip.SetDefault("Mini-Chlorophyte Saber, stabby version!" +
                "\nLaunches a spore cloud");
		...
		public override void SetDefaults() 
		{
			...
			Item.shoot = ModContent.ProjectileType<ChlorophyteShortswordP>(); // The projectile is what makes a shortsword work
		...
		{
			Recipe recipe = Recipe.Create(ModContent.ItemType<ChlorophyteShortsword>());
	...
	public class ChlorophyteShortswordP : ModProjectile
	{
