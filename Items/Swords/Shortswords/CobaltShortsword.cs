...
namespace GalacticMod.Items.Swords.Shortswords
{
	public class CobaltShortsword : ModItem
	{
        ...
        {
            Tooltip.SetDefault("Stabs fast and has autoswing");
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<CobaltShortswordP>(); // The projectile is what makes a shortsword work
			Item.shootSpeed = 2.1f; // This value bleeds into the behavior of the projectile as velocity, keep that in mind when tweaking values
		}

		public override void AddRecipes()
		{
			Recipe recipe = Recipe.Create(ModContent.ItemType<CobaltShortsword>());
	...
	public class CobaltShortswordP : ModProjectile
	{
