...
namespace GalacticMod.Items.Swords.Shortswords
{
	public class AdamantiteShortsword : ModItem
	{
		...
		{
			Tooltip.SetDefault("Adamantite Sword, stabby version!" +
                "\nSurronded by an aura of energy" +
                "\nStrikes launch spikes of adamantite");
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<AdamaniteShortswordP>(); // The projectile is what makes a shortsword work
		...
		{
			Recipe recipe = Recipe.Create(ModContent.ItemType<AdamantiteShortsword>());
	...
	public class AdamaniteShortswordP : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			Projectile.Size = new Vector2(42); // This sets width and height to the same value (important when projectiles can rotate)
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            for (int i = 0; i < numberProjectiles; i++)
            {
                ...
                Projectile.NewProjectile(null, new Vector2(Projectile.Center.X, Projectile.Center.Y), new Vector2(perturbedSpeed.X, perturbedSpeed.Y), ModContent.ProjectileType<AdamantiteSpikes>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
    ...
    public class AdamantiteSpikes : ModProjectile
    {
        public override void SetDefaults()
        {
            Projectile.width = 16;
