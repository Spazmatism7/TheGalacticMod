...
namespace GalacticMod.Items.Swords.Shortswords
{
	public class PalladiumShortsword : ModItem
	{
        ...
        {
            Tooltip.SetDefault("Higher chance to deal critical hits");
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<PalladiumShortswordP>(); // The projectile is what makes a shortsword work
			Item.shootSpeed = 2.1f; // This value bleeds into the behavior of the projectile as velocity, keep that in mind when tweaking values
		}

        public override void AddRecipes()
		{
			Recipe recipe = Recipe.Create(ModContent.ItemType<PalladiumShortsword>());
	...
	public class PalladiumShortswordP : ModProjectile
	{
