...
namespace GalacticMod.Items.PostML.Celestial
{
    public class StardustWhip : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToWhip(ModContent.ProjectileType<StardustWhipP>(), 200, 2, 4);
        ...
        {
            Recipe recipe = Recipe.Create(ModContent.ItemType<StardustWhip>());
    ...
    public class StardustWhipP : ModProjectile
    {
        bool boom = true;
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            if (boom)
            {
                Projectile.NewProjectile(null, target.Center, Projectile.velocity - Projectile.velocity, ModContent.ProjectileType<StardustExplosion>(),
            ...
            Projectile.damage = 7 * (Projectile.damage / 10); //30% multihit penalty
        }
    ...
    public class StardustExplosion : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Stardust Explosion");
