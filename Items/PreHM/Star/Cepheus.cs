...
namespace GalacticMod.Items.PreHM.Star
{
    public class Cepheus : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ProjectileType<CepheusProj>();
            Item.shootSpeed = 10f;
        }

        public override void AddRecipes()
        {
            Recipe recipe = Recipe.Create(ItemType<Cepheus>());
            recipe.AddIngredient(Mod, "Orion");
