...
{
	public class DemonEyeBuff : ModBuff
	{
		...
		{
			if (player.ownedProjectileCounts[ModContent.ProjectileType<DemonEye>()] > 0)
			{
	...
	public class DemonEyeStaff : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.buffType = BuffType<DemonEyeBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ProjectileType<DemonEye>();
		}
	...
	public class DemonEye : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(BuffType<DemonEyeBuff>());
			}
			if (player.HasBuff(BuffType<DemonEyeBuff>()))
			{
